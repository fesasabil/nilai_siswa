					...
					<div class="row fullscreen d-flex align-items-center justify-content-between">
						<div class="banner-content col-lg-9 col-md-12">
							<h1 class="text-uppercase">
								{{config('school.welcome_message')}}			
							</h1>
							<p class="pt-10 pb-10">
								{{config('school.sub_welcome')}}
							</p>
							<a href="{{config('school.welcome_message_url')}}" class="primary-btn text-uppercase">{{config('school.welcome_message_button')}}</a>
						</div>										
					</div>
				</div>					
			</section>
					...
					<div class="row">
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('school.home_feature_coloms1_title')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('school.home_feature_coloms1_content')}}
									</p>
									<a href="{{config('school.home_feature_coloms1_url')}}">{{config('school.home_feature_coloms1_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('school.home_feature_coloms2_title')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('school.home_feature_coloms2_content')}}
									</p>
									<a href="{{config('schoool.home_feature_coloms2_url')}}">{{config('school.home_feature_coloms2_text')}}</a>									
								</div>
							</div>
						</div>
						<div class="col-lg-4">
							<div class="single-feature">
								<div class="title">
									<h4>{{config('school.home_feature_coloms3_title')}}</h4>
								</div>
								<div class="desc-wrap">
									<p>
										{{config('school.home_feature_coloms3_content')}}
									</p>
									<a href="{{config('school.home_feature_coloms3_url')}}">{{config('school.home_feature_coloms3_text')}}</a>									
								</div>
							</div>
						</div>												
					</div>
